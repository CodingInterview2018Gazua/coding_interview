...
public class Test180816 {
	public static void main(String[] args) {
		...
		TreeNode<Integer> n4 = tree.createNode(4, n9, n10);
		TreeNode<Integer> n3 = tree.createNode(3, n7, n8);
	...
	public static boolean isBalancedTree(BinaryTree tree) {
		for(int i = 0; Math.pow(2, i) < tree.count; i++) {
			int rest = (int) (tree.count - Math.pow(2, i)); 
		}
